...
<title>订单详情页</title>
<meta name="description" content="订单详情页">
<meta name="keywords" content="订单详情页">
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${orders.member_tab.nickname }</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${orders.member_tab.name}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${orders.member_tab.phonenum}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${orders.member_tab.email}</div>
		...
		<strong>Copyright &copy; 2020-04-11 <a
			href="#">刘光强</a>.
